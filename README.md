...
src/
  ...
  games/                      נתוני החידות בלבד (מבוך, מסלולים, צירופים)
                              — הדפים המודפסים נשענים עליהם, אין קוד מסך
...
שבעת השעשועונים שהיו כאן הומרו לדפי עבודה, ו־`src/games/` שומר רק את
**נתוני** החידות ואת הבדיקות שמוכיחות שהן פתירות. יש בדיקת דפדפן שנכשלת
על כל `button`/`select`/`textarea` בעמוד ממוספר.
