...
אפליקציה אחת מאוחדת ללימוד מערכת הצירים ברביע הראשון: **50 עמודים ממוספרים** (דפי עבודה ו־8 שעשועונים משולבים), עמוד שער, תצוגת מובייל מצוינת והדפסת **A4** מקצועית — הכול בריפו אחד, בכתובת אחת ובקובץ כניסה אחד.

> ריפו יחיד מותר לפרויקט: `yanivmizrachiy/coordinate-first-quadrant`. אין לכתוב אל `yanivmizrachiy/parabula-next`.

## מה יש באפליקציה

- **דפי העבודה** — 50 עמודים מאורגנים לנושאים, עם ניווט עמוד־אחר־עמוד, תוכן עניינים, מסך מלא, שמירת המיקום האחרון והדפסת עמוד בודד.
- **החוברת המלאה** — עמוד השער ואחריו כל 50 העמודים, להדפסה כ־A4.
